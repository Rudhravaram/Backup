...
main_words,code_list,desc,block,block_desc=main_icd10('D & C WITH ELECTRO OR CRYOCAUTERY WITH OR WITHOUT AND POLYPECTOMY')#Z90.410
...
final_code,final_input=main_icd10_pcs('D & C/FRACTIONAL CURETTAGE.INCOMPLETE ABORTION/IST TRIMESTER ROUTINE MTP')
